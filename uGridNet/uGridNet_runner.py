...
def PoleElevation(gen_LON, gen_LAT, gen_indexes, target_indexes, d_EW_between, d_NS_between):
    ...
    #GPD = GPD.to_crs("WGS84") #GPD.to_crs("EPSG:32631") #GPD.to_crs("EPSG:22289")  # Transform to UTM (Mercator)
    ...
    print(f'newGDF: {newGDG}')
    #new_GDF = new_GDF.set_crs("WGS84") #new_GDF.set_crs("EPSG:32631") #new_GDF.set_crs("EPSG:22289")  # EPSG:3857
