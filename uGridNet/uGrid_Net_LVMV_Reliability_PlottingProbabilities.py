...
if __name__ == "__main__":
    ...
    minPoles = 75#int(Net_Parameters['minPoles'][0])
    maxPoles = 76#int(Net_Parameters['maxPoles'][0])
            ...
            while nrep_MV < repeats_MV_poles and NoDecrease == 0:
                ...
                for prob_LV in probabilities:
                    for prob_MV in probabilities:
                        ...
                        filename = "Probability_Effects_probLV_%s_probMV_%s.csv" %(str(prob_LV),str(prob_MV))
